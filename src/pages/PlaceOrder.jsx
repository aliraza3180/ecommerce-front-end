        ...
        <div className="mt-12">
          ...
          <div className="flex flex-col gap-3 lg:flex-row">
            ...
            <div
              ...
              className={`flex items-center gap-3 border p-2 px-3 cursor-pointer ${method === "razor" ? "border-green-400" : ""}`}
            >
              <p
                className={`min-w-3.5 h-3.5 border rounded-full ${method === "razor" ? "bg-green-400" : ""}`}
              ></p>
